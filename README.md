...
<li>
Apply the preprocessor to the raw WEC training data <b>before training the WECs</b>. WOMBAT provides the script <pre>tools/apply_preprocessor.py</pre> for that purpose.
