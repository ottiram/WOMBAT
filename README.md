...
<li>
Apply the preprocessor to the raw WEC training data <b>before training the WECs</b>. WOMBAT provides the script <span style="font-name:courier">tools/apply_preprocessor.py</span> for that purpose.
